"""Check if PipeWire echo cancellation is active on default capture. Run manually."""
import subprocess
...
def main() -> None:
    ...
    result = subprocess.run(["pw-link", "-l"], capture_output=True, text=True, timeout=5, check=False)
