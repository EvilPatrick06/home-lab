...
Awarding magic items is the purview of the DM. You can award a magic item because the story calls for it or the players would be especially pleased to have it. This section helps you determine which magic items end up in the characters' possession.
...
It usually takes a Magic action to activate a magic item. The item's user might also need to do something special. The description of each item category or individual item details how an item is activated.
...
A magic item's description specifies whether it bears a curse. Most methods of identifying magic items, including the *Identify* spell, fail to reveal such a curse.
...
If a magic item incorporates an item that has a purchase cost (such as a weapon or a suit of armor), you must also pay that entire cost or craft that item using the rules in the *Player's Handbook*. For example, to make *+1 Armor* (Plate Armor), you must pay 5,500 GP or pay 2,000 GP and craft the armor.
...
| 3 | **Heroic.** A great hero once wielded this item. Anyone who knows this item's history expects great deeds from the new owner. |
...
| 5--6 | **Guardian.** The item warns you, granting +2 bonus to your Initiative rolls if you don't have the Incapacitated condition. |
...
| 93--00 | While attuned to the Artifact, Beasts within 30 feet of you that have a Challenge Rating of 6 or lower are Hostile toward you. |
...
The DM controls sentient items and their activated properties. A bearer who maintains a good relationship with the item can access those properties. If the relationship is strained, a conflict can ensue (see "Conflict" below).

### Sentient Magic Item Traits

When you make a sentient magic item, you create its persona much as you would create an NPC (as described in the "Nonplayer Characters" section of chapter 3), with these exceptions.
...
Use the tables in this section to randomly determine the magic items the characters find in your adventures. The tables are sorted first by treasure theme (as described in the *Monster Manual*), and then by item rarity. If an item isn't associated with a theme, roll 1d4 to decide which table to roll on next: on a 1, roll on the Arcana tables; on a 2, Armaments; on a 3, Implements; and on a 4, Relics.
...
| 32--33 | *Iron Flask* |
| 34--41 | *Potion of Giant Strength* (storm) |
...
| 91--93 | *Walloping Ammunition* |
| 94--96 | *Wand of Conducting* |
| 97--00 | *Wand of Pyrotechnics* |
...
| 71--80 | *Spell Scroll* (level 2 or 3 spell) |
...
| 66--73 | *Spell Scroll* (level 4 or 5 spell) |
...
| 56--65 | *Spell Scroll* (level 6, 7, or 8 spell) |
| 66--70 | *Spirit Board* |
| 71--75 | *Staff of Fire* |
