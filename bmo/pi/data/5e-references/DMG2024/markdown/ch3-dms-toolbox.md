...
Creatures being chased can split up into smaller groups. This tactic forces pursuers to either divide their forces or allow some of the quarry to escape. If a pursuit splits into several smaller chases, resolve each chase separately. You can keep all creatures in Initiative order, but track the distances separately for each group.
...
Unusual environments might suggest unique chase tables. A chase through the sewers of the Free City of Greyhawk or through the spiderweb-filled alleys of Menzoberranzan (a subterranean city teeming with spiders and worshipers of Lolth) might inspire you to create your own chase tables.
...
You can tweak one or more existing ones. Suggestions are provided in the sections that follow.
...
You can alter a magic item's form while leaving its properties intact. For example, you can turn a *Ring of the Ram* into a wand or a *Cloak of Protection* into some worn object (such as a circlet) without altering the item's properties.
...
- **Identity.** Make sure the spell fits with the identity of those who cast it. Sorcerers and Wizards don't typically cast healing spells, for example.
...
**Demonic Possession.** Demonic Possession arises from the chaos and evil of the Abyss and commonly besets creatures that interact with demonic objects or linger in desecrated locations, where bodiless demonic spirits await victims.
...
| 65–66 | Intended as a death trap to eliminate any creature that enters, perhaps to guard treasure or to harvest souls for a necromantic rite |
...
Traveling at altitudes of 10,000 feet or higher above sea level is taxing for most creatures because of the reduced amount of oxygen in the air. Each hour a creature spends traveling at high altitude counts as 2 hours for the purpose of determining how long that creature can travel (see "Travel Pace" in chapter 2).
...
Thin ice has a weight tolerance of 3d10 x 10 pounds per 10-foot-square area. Whenever the total weight on an area of thin ice exceeds its tolerance, the ice in that area breaks. All creatures on broken ice fall through. Below the ice is frigid water (see "Frigid Water" above).
...
Whenever a creature expends a spell slot to cast a spell in a wild magic zone, roll 1d20. If you roll a 20, roll on the Wild Magic Surge table in the *Player's Handbook* to create a magical effect.
...
The *Player's Handbook* describes common hazards that adventurers encounter, such as falling and dehydration. This section details some unusual hazards you can add to a location to make it more challenging.
...
| 7 | 12 | 4 | 3/4 | 4/5 | 4/6 | 5/8 | 7/10 |
| 8 | 13 | 5 | 3/4 | 3/5 | 4/6 | 5/8 | 7/10 |
| 9 | 14 | — | 2/4 | 3/5 | 3/6 | 4/6 | 6/10 |
...
Name, Alignment, Appearance, Stat Block, Personality, Secret
...
| 1d20 | Claim to Fame | 1d20 | Claim to Fame |
|---|---|---|---|
| 1 | Delicious food | 11 | Piety |
| 2 | Rude people | 12 | Gambling |
| 3 | Friendly folk | 13 | Godlessness |
| 4 | Artists or writers | 14 | Education |
| 5 | Great hero/savior | 15 | Wines |
| 6 | Flowers | 16 | High fashion |
| 7 | Seasonal festival | 17 | Political intrigue |
| 8 | Hauntings | 18 | Powerful guilds |
| 9 | Spellcasters | 19 | Patriotism |
| 10 | Decadence | 20 | Ancient ruins |
...
| 1d20 | Type | 1d20 | Type |
|---|---|---|---|
| 1 | Pawnshop | 11 | Smithy |
| 2 | Apothecary | 12 | Carpenter |
| 3 | Grocer | 13 | Weaver |
| 4 | Delicatessen | 14 | Jeweler |
| 5 | Potter | 15 | Baker |
...
A Cannon uses gunpowder or arcane power to propel heavy iron balls at destructive speeds. A Cannon is usually attached to a wooden frame with wheels. Loading a Cannon requires the Utilize action, and aiming it requires another Utilize action. Then a crew member can take the Cannonball action.
...
***Flamethrower.*** *Dexterity Saving Throw:* DC 15, each creature in a 60-foot-long, 5-foot-wide Line. *Failure:* 14 (4d6) Fire damage, and the creature starts burning. *Success:* Half damage only.
...
***Toxic Keg (Requires Load and Aim).*** *Constitution Saving Throw:* DC 15, each creature in a 20-foot-radius Sphere centered on a point 30 to 300 feet from the launcher. *Failure:* 14 (4d6) Poison damage. *Success:* Half damage.

A back-mounted, wooden catapult flings small kegs of toxic gas. Loading a Keg Launcher requires the Utilize action, and aiming it requires another Utilize action. Then a crew member can take the Toxic Keg action.
...
A Mangonel is a catapult that hurls heavy projectiles in a high arc, so it can hit targets behind walls. Loading a Mangonel requires two Utilize actions, and aiming it requires two more Utilize actions. Then a crew member can take the Mangonel Stone action.
...
A Ram consists of a movable gallery equipped with a heavy log suspended from two roof beams by chains. The log is shod in iron and used to batter through doors and barricades. Positioning a Ram requires three Utilize actions. Then a crew member can use the Ram action.
...
An iron pot is suspended so that it can be tipped easily, spilling its contents. Once emptied, a cauldron must be refilled before it can be used again. Filling the cauldron requires three Utilize actions. Then a crew member can take the Spill action.

Cauldrons are typically filled with boiling oil but can be filled with other substances, such as acid or green slime (see "Hazards" in this chapter), with different effects.
...
A Trebuchet is a catapult that throws its payload in a high arc so it can hit targets behind walls. Loading a Trebuchet requires two Utilize actions, and aiming it requires two more Utilize actions. Then a crew member can take the Trebuchet Stone action.
...
A Charm can't be removed from a creature by anything short of divine intervention or a *Wish* spell. A character can't benefit from multiple instances of a Charm at the same time. A typical Charm mimics the effects of a Potion or spell, so it is easy to create more Charms of your own.
...
As a Search action, a creature can examine a section of floor that forms the pressure plate and make a DC 15 Wisdom (Perception) check, detecting the pressure plate on a successful check. Wedging an Iron Spike or a similar object under the pressure plate prevents the trap from triggering.
...
| Levels | Nuisance Traps | | | Deadly Traps | | |
|---|---|---|---|---|---|---|
| | Attack Bonus | Save DC | Damage | Attack Bonus | Save DC | Damage |
