...
If your attack roll with this weapon misses a creature, you can deal damage to the creature equal to the ability modifier you used to make the attack roll. This damage is the same type dealt by the weapon, and the damage can be increased only by increasing the ability modifier.
...
The Armor table lists the game's main armor. The table includes the cost and weight of each armor, as well as the following details:
...
>
> In most campaigns, you can use or wear any equipment you find on your adventures within the bounds of common sense. For example, an orc adventurer won't fit in a halfling's Leather Armor, and a cloud giant's robe would be far too large for a gnome.
>
...
**Variants.** This appears if the tool has variants, which are listed. Each requires a separate proficiency.
...
If a vehicle has a damage threshold (see the rules glossary), it's noted in the table.
...
You can't wear more than one of certain magic items. You can't normally wear more than one pair of footwear or gloves or gauntlets, one pair of bracers, one suit of armor, one item of headwear, or one cloak. The DM might make exceptions.
...
A spellcaster can transfer a spell and create a *Spell Scroll*, using the rules below.
