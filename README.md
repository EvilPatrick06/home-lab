...
- **`dnd-app`** at **v2.4.53**. Multiplayer (Phase 29), Token System (Phase 13), and DM View (Phase 14) shipped. 724 test files. Ships as Windows NSIS installer + Linux AppImage. Open backlog + deferred work: `dnd-app/docs/phases/REVIEW-REPORT-2026-05-29.md` (the phase-plan files were consolidated into that single report).
