...
import { commands } from './commands-player-conditions'

describe('commands-player-conditions', () => {
  ...
  it('all condition commands are player category and not dmOnly', () => {
    for (const cmd of commands) {
