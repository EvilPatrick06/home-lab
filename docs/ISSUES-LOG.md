...
> **Active bugs / tech debt / broken config — things that are wrong and need fixing.**
> Sibling logs:
> - Future ideas, design gotchas, observations → [`SUGGESTIONS-LOG.md`](./SUGGESTIONS-LOG.md)
> - Security concerns / incidents → [`SECURITY-LOG.md`](./SECURITY-LOG.md) *(gitignored)*
...
> Future ideas, design gotchas, observations live in [`SUGGESTIONS-LOG.md`](./SUGGESTIONS-LOG.md). Security entries live in [`SECURITY-LOG.md`](./SECURITY-LOG.md) (gitignored). Resolved issues live in [`RESOLVED-ISSUES.md`](./RESOLVED-ISSUES.md).
