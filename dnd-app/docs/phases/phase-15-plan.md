...
**15d — COMPLETE 2026-05-28.** Remaining: 15e (in-game token/encounter EntryRef + live HP/CR), 15f (Bastion store + new UI dir), 15g (macro/chat/audio/etc + allowlist shrink), 15h (migration framework + cleanup; release skipped per user — cloud session).
