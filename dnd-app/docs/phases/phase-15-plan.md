...
Steps 9, 12-19 (excluding 19 board-test, which still needs consumer flip) deferred to next 15a iteration. Verified 2026-05-19: data-store flip, migration v4, report modal, and boundary test still pending — see the relevant Sub-Phase Details sections.
