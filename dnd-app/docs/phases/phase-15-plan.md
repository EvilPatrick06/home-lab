...
**15e — COMPLETE 2026-05-28. 15f — COMPLETE 2026-05-28.** Remaining for Phase 15: 15g (macro/chat/audio/weather/calendar/shop/UI-config sweep + boundary allowlist shrink + `content-index` absorb), 15h (migration framework v4 + cleanup / delete `use-data-store` + legacy `*-tables`; optional v4 token-inline-strip migration; release skipped per user — cloud session).
