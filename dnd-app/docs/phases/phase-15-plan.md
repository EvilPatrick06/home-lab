...
**15e/15f/15g — COMPLETE 2026-05-28.** Remaining for Phase 15: 15h (migration framework v4 + cleanup / delete `use-data-store` + legacy `*-tables`; optional v4 token-inline-strip migration; release skipped per user — cloud session).
