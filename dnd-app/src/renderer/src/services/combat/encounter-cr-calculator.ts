 ...
 *
 * The XP budget table is the shared single source of truth (src/shared/
 * encounter-budgets.ts), also consumed by the AI context-builder so the UI and
 * the AI agree on encounter thresholds.
 */

import { XP_BUDGET_BY_LEVEL as XP_BUDGET } from '../../../../shared/encounter-budgets'
