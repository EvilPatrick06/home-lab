...
export default function ScreenReaderPrompt(): JSX.Element | null {
  ...
  return (
    ...
    >
      <div className="bg-surface border border-border rounded-xl p-6 max-w-sm w-full mx-4 text-center shadow-2xl">
        <h2 id="sr-prompt-title" className="text-lg font-bold text-fg mb-2">
          {t('ui.screenReaderPrompt.title')}
        </h2>
        <p className="text-sm text-muted mb-5">{t('ui.screenReaderPrompt.description')}</p>
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            className="px-4 py-2 text-sm rounded-lg bg-amber-600 hover:bg-accent-strong text-white font-semibold cursor-pointer"
          >
