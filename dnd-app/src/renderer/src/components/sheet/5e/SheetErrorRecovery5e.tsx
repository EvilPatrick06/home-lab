  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-lg w-full bg-gray-900 border border-amber-500/40 rounded-xl p-6 shadow-xl">
        <h2 className="text-base font-semibold text-amber-400 mb-2">{t('sheet.errorRecovery.title')}</h2>
        <p className="text-sm text-gray-400 mb-4">{t('sheet.errorRecovery.description')}</p>
        {isDev && error && (
