...
- **Library** — browse ~3,000 JSON files of monsters / spells / items / feats. Recently-viewed list at the top.
...
Current baseline: **837 test files**, lint + both tsc projects clean.
...
│   │   └── public/data/5e/       D&D 2024 content (~3,000 JSON files)
...
- ~3,000 JSON files in `public/data/5e/` make the renderer bundle big — lazy load via the `@data` alias + dynamic `import()`.
