...
- **Library**: 3,041 JSON files of D&D 2024 content (monsters, spells, items, equipment, traps, hazards, environments). Recently-viewed list with Clear button. Homebrew per category.
...
- **Library** — browse 3,041 JSON files of monsters / spells / items / feats. Recently-viewed list at the top.
...
- 3,041 JSON files in `public/data/5e/` make the renderer bundle big — lazy load via the `@data` alias + dynamic `import()`.
