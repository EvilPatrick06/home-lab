...
def _init_settings_file():
    """Create default ~/bmo/data/settings.json if it doesn't exist."""
...
def _show_custom_commands():
    ...
    if not commands:
        ...
        _print_dim("Create .bmo/commands/<name>.md or ~/bmo/data/commands/<name>.md")
        return
...
def _show_help():
    if HAS_RICH:
        ...
        table.add_row("/settings init", "Create default ~/bmo/data/settings.json")
