...
sys.path.insert(0, os.path.expanduser("~/bmo"))
...
bmo_model = Model(wakeword_models=[os.path.expanduser("~/bmo/hey_bmo.onnx")], inference_framework="onnx")
...
piper_model = os.path.expanduser("~/bmo/models/piper/en_US-hfc_female-medium.onnx")
