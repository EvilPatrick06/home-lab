"""Debug Gemini 3 Flash streaming to understand thinking model SSE format."""
...
url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash-preview:streamGenerateContent?key={key}&alt=sse"
