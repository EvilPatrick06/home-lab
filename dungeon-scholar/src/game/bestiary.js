...
export const BESTIARY_ENTRIES = {
  ...
  lich: {
    ...
    lore: {
      ...
      expanded:
        'Once a brilliant cryptographer, he memorised every private key the world has ever forged. Each correct answer chips at the seal that binds him here.',
      secret:
        'His true name is bound in his last unpublished paper, lost in the catacombs. Find that scroll and his binding breaks before the gauntlet ends.',
    },
  ...
  hydra: {
    ...
    lore: {
      ...
      expanded:
        'It was born from a fork bomb that escaped a CTF lab. Each head is one of the spawned children, refusing to die.',
  ...
  sphinx: {
    ...
    lore: {
      ...
      secret:
        'Its riddle is itself — answer it not, and it answers thee. Speak the question aloud to undo the binding.',
    },
  ...
  behemoth: {
    ...
    lore: {
      ...
      expanded:
        'Bare-metal made flesh — the union of every server that refused to upgrade. It hits twice as hard but the punches are deterministic.',
      secret:
        'Patch its kernel and it falls. The patch lives in a forgotten changelog, hidden behind seven Adept clears.',
    },
  ...
  riddler: {
    ...
    lore: {
      ...
      expanded:
        'He was a senior tester who solved every CTF before grading. None of his colleagues could prove a winner; none could prove a loser either.',
      secret:
        'His mask is the flag — read it backwards. The reversal is engraved on the inside of the mask he never removes.',
    },
