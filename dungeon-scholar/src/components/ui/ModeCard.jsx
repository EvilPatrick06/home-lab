...
export function ModeCard({ title, desc, icon, color, onClick, featured, disabled, disabledReason }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-14 h-14 rounded-sm bg-linear-to-br ${c.grad} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform border-2 border-amber-600/50`}
        style={{
      ...
      <h3 className={`text-xl font-bold mb-1 italic ${c.text}`} style={{ textShadow: `0 0 8px ${c.glow}` }}>
        {title}
      </h3>
