export function OrnatePanel({ children, color = 'amber', className = '', glow = true }) {
  ...
  const colorMap = {
    amber: { border: 'rgba(180, 83, 9, 0.6)', glow: 'rgba(245, 158, 11, 0.2)', bgVar: 'var(--panel-bg-amber, rgba(var(--surface-amber, 41, 24, 12), 0.85))' },
    ...
    purple: { border: 'rgba(126, 34, 206, 0.6)', glow: 'rgba(168, 85, 247, 0.2)', bgVar: 'var(--panel-bg-purple, rgba(var(--surface-purple, 31, 12, 41), 0.85))' },
