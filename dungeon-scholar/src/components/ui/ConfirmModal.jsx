    ...
    >
      ...
      >
        <div className="p-4 border-b border-amber-700/40">
          <h3
            id="ds-confirm-title"
            className={`text-xl font-bold italic ${confirmIsDanger ? 'text-red-300' : 'text-amber-300'}`}
          >
            {title}
          </h3>
        </div>
        ...
        <div className="p-4 border-t border-amber-700/40 flex gap-2">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: confirmIsDanger ? '0 0 18px rgba(220, 38, 38, 0.5)' : '0 0 18px rgba(245, 158, 11, 0.5)',
            }}
          >
            {confirmLabel}
          </button>
