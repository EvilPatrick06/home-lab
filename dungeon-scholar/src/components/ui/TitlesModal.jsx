...
import { SPECIAL_TITLES, TITLES } from '../../game/titles.js';
      ...
      >
        <div className="p-4 border-b border-amber-700/50 flex justify-between items-center">
          ...
          <button
            ...
            aria-label="Close choose title dialog"
          >
          ...
          <div>
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full text-left p-3 rounded-sm border-2"
                style={{
                  background: !playerState.selectedTitle
                    ? 'rgba(var(--surface-amber-strong, 120, 53, 15), 0.5)'
                    : 'rgba(var(--surface-amber, 41, 24, 12), 0.4)',
                  borderColor: !playerState.selectedTitle
                    ? 'rgba(245, 158, 11, 0.8)'
                    : 'rgba(var(--surface-amber-strong, 120, 53, 15), 0.5)',
                }}
              >
                  ...
                  <div
                    ...
                    style={{
                      background: unlocked
                        ...
                        : 'rgba(var(--surface-modal, 20, 12, 6), 0.4)',
              ...
              {Object.entries(SPECIAL_TITLES).map(([key, t]) => {
                ...
                return (
                  <button
                    ...
                    disabled={!unlocked}
                    className="w-full text-left p-3 rounded-sm border-2 disabled:cursor-not-allowed"
                    style={{
                      background:
                        playerState.selectedTitle === key
                          ? 'rgba(126, 34, 206, 0.4)'
                          : unlocked
                            ? 'rgba(var(--surface-amber, 41, 24, 12), 0.5)'
                            : 'rgba(var(--surface-modal, 20, 12, 6), 0.4)',
