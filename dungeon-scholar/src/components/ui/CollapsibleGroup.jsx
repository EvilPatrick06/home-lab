...
export function CollapsibleGroup({ title, icon, color = 'amber', defaultOpen = true, children }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(135deg, rgba(var(--surface-modal, 20, 12, 6), 0.55) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.92) 100%)',
    ...
    >
      ...
      >
        ...
        <span
          ...
          style={{ background: `linear-gradient(to right, ${palette.border}, transparent)` }}
        />
      </button>
