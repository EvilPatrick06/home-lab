  ...
  render() {
    ...
    if (isChunkLoadError(this.state.error)) {
      return (
        <div
          ...
          aria-live="assertive"
        >
          <div className="text-xs italic tracking-[0.25em] uppercase text-amber-300 mb-3">
            ✦ The tome has been rebound ✦
          </div>
          ...
          <p className="text-sm italic text-amber-100 mb-4">
            A fresh version of Dungeon Scholar was published while thou wast reading. Reload to fetch the latest pages —
            thy saved progress is safe.
          </p>
    ...
    return (
      ...
      >
        ...
        <p className="text-sm italic text-amber-100 mb-4">
          The page thou wast viewing crashed unexpectedly. Thy saved progress is safe — step back to the Hearth and try
        ...
        <details className="mb-4 text-xs italic text-amber-100/70">
          ...
          <pre
            className="mt-2 p-2 rounded-sm overflow-x-auto text-[10px] whitespace-pre-wrap"
            style={{
