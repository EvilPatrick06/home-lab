          ...
          {mode === 'create' && (
            <form onSubmit={handleCreate}>
              ...
              <button
                type="submit"
                disabled={busy}
                className="w-full py-3 font-bold rounded-sm flex items-center justify-center gap-2 btn-gold-ink border-2 border-amber-300 italic disabled:opacity-60"
                style={{
          ...
          <div className="p-4 border-t border-amber-700/50 flex flex-col gap-2">
            <div className="flex gap-2">
              <button
                onClick={handleSave}
                disabled={busy}
                className="flex-1 py-3 font-bold rounded-sm flex items-center justify-center gap-2 btn-gold-ink border-2 border-amber-300 italic disabled:opacity-60"
                style={{
                  background: 'linear-gradient(to bottom, #fde047 0%, #f59e0b 100%)',
                  boxShadow: '0 0 20px rgba(245, 158, 11, 0.5)',
                }}
