...
import { findItem, ITEM_CATEGORIES, ITEMS } from '../../game/items.js';
...
function InventoryScreen({
  ...
  const itemsByCategory = Object.keys(ITEM_CATEGORIES).reduce((acc, cat) => {
    acc[cat] = ITEMS.filter((it) => it.category === cat && (inv[it.id] || 0) > 0).map((it) => ({
      ...it,
      count: inv[it.id],
    }));
    return acc;
              ...
              {items.map((it) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(var(--surface-purple, 31, 12, 41), 0.65) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.95) 100%)',
                            ...
                            {[0, 1, 2].map((i) => {
                              ...
                              return (
                                <button
                                  ...
                                  title={
                                    isOther
                                      ? `Replace ${findItem(filledId)?.name || 'current'} in slot ${i + 1}`
                                      : `Slot ${i + 1}`
                                  }
                                >
                                  {i + 1}
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-emerald-400 tracking-[0.2em] italic">⚜ THY GATHERED TREASURES ⚜</div>
        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              style={{
                background: active
                  ? 'rgba(var(--surface-amber, 41, 24, 12), 0.85)'
                  : 'rgba(var(--surface-modal, 20, 12, 6), 0.5)',
      ...
      {tab === 'gear' && (
        <>
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(var(--surface-amber-strong, 120, 53, 15), 0.35) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.92) 100%)',
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3
                className="text-base font-bold text-amber-200 italic tracking-wider"
                style={{ textShadow: '0 0 8px rgba(245,158,11,0.3)' }}
              >
                Loadout
              </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {SLOTS.map((s) => {
                ...
                return (
                  <div
                    key={s.id}
                    className="p-3 rounded-sm flex items-center gap-2"
                    style={{
          ...
          {tabItemCount === 0 ? (
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(var(--surface-purple, 31, 12, 41), 0.5) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.9) 100%)',
      ...
      {tab === 'potions' && (
        <>
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(var(--surface-emerald, 6, 78, 59), 0.35) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.92) 100%)',
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3
                className="text-base font-bold text-emerald-200 italic tracking-wider"
          ...
          {tabItemCount === 0 ? (
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(var(--surface-emerald, 6, 78, 59), 0.35) 0%, rgba(var(--surface-deep, 10, 6, 4), 0.9) 100%)',
      ...
      <div className="text-center pt-2 flex flex-wrap justify-center gap-2">
        <button
          ...
          className="px-4 py-2 rounded-sm text-xs italic border-2 border-amber-700 text-amber-300 hover:bg-amber-900/30 inline-flex items-center gap-2"
        ...
        <button
          ...
          className="px-4 py-2 rounded-sm text-xs italic border-2 border-emerald-700 text-emerald-300 hover:bg-emerald-900/30 inline-flex items-center gap-2"
