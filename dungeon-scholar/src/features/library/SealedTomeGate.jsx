    ...
    <div className="max-w-md mx-auto mt-12">
      <OrnatePanel color="purple">
        <div className="flex flex-col items-center text-center gap-3">
          <Lock className="w-10 h-10 text-purple-300" aria-hidden="true" style={{ filter: 'drop-shadow(0 0 8px rgba(168, 85, 247, 0.5))' }} />
          <h2 className="text-xl font-bold italic text-purple-200">This tome is sealed</h2>
          <p className="text-sm italic text-amber-100/80 truncate max-w-full" title={title}>{title}</p>
          <p className="text-xs italic text-amber-100/60">
            Its scrolls, riddles, and labs are warded. Speak the proctor&rsquo;s passphrase to break the seal for this session.
          </p>
          ...
          >
            {busy ? <><Loader2 className="w-4 h-4 animate-spin" aria-hidden="true" /> Unsealing…</> : <><Lock className="w-4 h-4" aria-hidden="true" /> Unlock</>}
          </button>
